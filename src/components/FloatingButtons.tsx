  ...
  return (
    <div className="fixed right-4 bottom-4 z-50 flex flex-col gap-3 sm:right-6 sm:bottom-6">
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-800 text-white shadow-lg shadow-brand-900/30 transition-transform hover:scale-105"
      >
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-brand-900/30 transition-transform hover:scale-105"
      >
